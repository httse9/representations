...
from minigrid_basics.envs import mon_minigrid, maxent_mon_minigrid
...
flags.DEFINE_string('env_name', 'maxent_empty', 'Name of the environment.')
...
def main(argv):
  ...
  gin.parse_config_files_and_bindings(
      [os.path.join(maxent_mon_minigrid.GIN_FILES_PREFIX,
  ...
  os.makedirs(FLAGS.file_path, exist_ok=True)
